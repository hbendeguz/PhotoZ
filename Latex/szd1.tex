...
\section{Sloan Digital Sky Survey}
 ...
 \section{A tanulítóhalmaz elkészítése}
 ...
 \centering
  ...
  \hspace{2cm}
  \begin{subfigure}[b]{0.35\textwidth}
    \includegraphics[width=\textwidth, height = 0.95\textwidth]{Figures/relf.pdf}
    \label{fig:2}
  \end{subfigure}
  \caption{A \textit{korrelációs térkép}, a \textit{Random forest} tanulásában a különböző tulajdonságok relatív fontossága. }
  \label{fig:dist}
 \end{figure}
