...
\begin{tikzpicture}[shorten >=0pt,->,draw=black!50, node distance=\layersep]
    ...
    % This is the same as writing \foreach \name / \y in {1/1,2/2,3/3,4/4}
        \node[input neuron, pin=left:adat param\'eter \y] (I-\name) at (0,-\y) {};
    ...
    % Draw the output layer node
        ...
        \node[output neuron,pin={[pin edge={->}]right:Predikci\'o}, right of=H-3] (O) {};
    ...
    % Annotate the layers
    \node[annot,above of=H-1, node distance=1cm] (hl) { K\"oztes r\'eteg};
    \node[annot,left of=hl] {Bemeneti r\'eteg};
    \node[annot,right of=hl] {Kimeneti r\'eteg};
\end{tikzpicture}
% End of code
\end{document}